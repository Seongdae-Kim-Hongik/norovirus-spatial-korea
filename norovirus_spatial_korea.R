...
# ==============================================================================
# Foodborne norovirus spatial analysis, v8-B (PRE-SPECIFIED / honest) — NB, urban/rural 3-group stratified
#   v8(AUTO) -> v8-B change: REMOVED the target-driven AUTO selection (forward to >=5 hits + reverse-direction auto-drop).
#      The pre-specified theory covariate set (Total/Urban TV_v6, Rural TV_RURAL) is fitted ONCE.
#      Significance and direction are reported exactly as the data give them (no soft p-hacking).
#
